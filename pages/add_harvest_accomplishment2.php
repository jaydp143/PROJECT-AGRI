                ...
                <div class="col-sm-12">
                  <table  class='table  table-sm table-striped ' id="dynamic_field" style='text-align:center;'>
                      ...
                      <tbody>
                            ...
                            <td align="center"><input type="text" class="form-control" name="production1[]" onkeypress="return isNumber(event)"></td>
                            <td align="center"><input type="text" class="form-control" name="area2[]" onkeypress="return isNumber(event)"></td>
                            <td align="center"><input type="text" class="form-control" name="production2[]" onkeypress="return isNumber(event)"></td>
                            <td align="center"><input type="text" class="form-control" name="area3[]" onkeypress="return isNumber(event)"></td>
                            <td align="center"><input type="text" class="form-control" name="production3[]" onkeypress="return isNumber(event)"></td>
                            </tr>
