...
<head>
  ...
  <title>CROP SCHEDULE PER MUNICIPALITY</title>
  <?php
          ...
          <div class="col-sm-8">
            <?php
               ...
               // $rowMun=mysqli_fetch_assoc($queryMun);
                $date_planting=$_GET['date_sched']
            ?>
            <h1>Rice Crops Planted on <?php echo date_format(date_create($date_planting),"F d, Y") ; ?></h1>
            <a class="btn bg-gradient-info  btn-sm" href="crop_schedule.php">
        ...
        <div class="container-fluid">
            <div class="row">  
                <div class="col-12">
                  ...
                  <tbody>
                  <?php
                    $query = mysqli_query($connection,"SELECT pl.mun_id, pl.seed_id, pl.seed_type_id,  pl.eco_id, pl.planting_id, pl.season,pl.areas, pl.farmers, pl.date_monitored, (SELECT mn.municipality FROM tbl_municipality as mn where mn.mun_id=pl.mun_id)municipality, (SELECT sd.seed_description FROM tbl_seed as sd WHERE sd.seed_id=pl.seed_id)seed, (SELECT sdt.seed_type FROM tbl_seed_type as sdt WHERE sdt.seed_type_id=pl.seed_type_id)seed_type, (SELECT es.ecosystem FROM tbl_ecosystem as es WHERE es.eco_id=pl.eco_id)ecosystem FROM tbl_planting as pl WHERE pl.date_monitored='".$_GET['date_sched']."' ORDER BY pl.planting_id ASC");
