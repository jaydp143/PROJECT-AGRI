                  ...
                  <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <select class="form-control" name="report" id="report" required >
                            <option value=""></option>
                            <option value="1">PLANTING REPORT SUMMARY</option>
                            <option value="2">PLANTING REPORT BY SEED TYPE</option>
                            <option value="3">PLANTING REPORT BY ECOSYSTEM</option>
                        </select>
                    </div>
                  </div>
                  <div class="col-md-3">
...
<script>
  function displayreport(r,s,y) {
    if (r==1){
        document.getElementById("frame1").src="report_planting1.php?season="+s+"&&year="+y;
    }
    else if (r==2){
        document.getElementById("frame1").src="report_plantingBST.php?season="+s+"&&year="+y;
    }
    else if (r==3){
        document.getElementById("frame1").src="report_plantingBEco.php?season="+s+"&&year="+y;
    }
    else{
